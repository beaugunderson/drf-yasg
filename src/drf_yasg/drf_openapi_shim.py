...
from drf_yasg.inspectors import InlineSerializerInspector, SwaggerAutoSchema, force_serializer_instance, NotHandled
...
SwaggerAutoSchema.field_inspectors.insert(0, DrfOpenAPICompatInspector)
